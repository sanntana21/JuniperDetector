#!/usr/bin/env python3
"""Barre el umbral de confianza hacia arriba en los expertos por región evaluados en solitario.

Recorre los umbrales superiores al suelo de exportación de los dos expertos de la ejecución
por región, sobre el test fotointerpretado y el test de trabajo de campo. Escribe
barrido_expertos_region.csv con las filas de S-IoU al 50 % de solapamiento, para que el
calibrado lea cada experto en su propio umbral.
"""
...
RUNS = ["juniperus_seg_by_region_20260831_073029"]
MECS = ["expert_E_region0_solo", "expert_E_region1_solo"]
...
def main():
    ...
    d = d[d.metric == "S-IoU"]
    out = "/home/santana/Documents/docs_TFM/analisis/barrido_expertos_region.csv"
